...
const { addBookings, getAllbookings, deleteBooking, updateBooking, getComplementry, roomAvailability, getBooking } = require('../controllers/newbookingcontrolller');
...
router.get('/getallbookings', authMiddleware, roleMiddleware(['admin', 'agent']), getAllbookings);
